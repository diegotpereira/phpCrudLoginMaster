...
if(strlen($_POST['nome'])){
    if(sendMail($_POST['email'],'diegoteixeirapereira@gmail.com', $_POST['mensagem'], 'Formulário de contato')){
        echo "Sua mensagem foi enviada com sucesso!";
    }
    else{
        echo "Ocorreu um erro ao enviar";
    }
    echo "<br><a href='cabecalho.php'>Voltar</a>";
    exit();
}
?>
<!DOCTYPE html>
...
<head>
	...
	<link rel="stylesheet" href="style-mail.css" type="text/css" media="all" />
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
</head>
<body>
	<h2>Formulário de contato - <a href="https://github.com/diegotpereira">GitHub</a></h2>
